diff --git a/StatusTabsUI.lua b/StatusTabsUI.lua
index 063ad6dbd931bc886b1055e10893ebd5074dd7cc..d88c6c68b93b0583e20533096497de623cc85eea 100644
--- a/StatusTabsUI.lua
+++ b/StatusTabsUI.lua
@@ -1,74 +1,128 @@
...
-		warnlog("POS2.X.Scale >= 1 >   ! :", POS2.X.Scale)
-	end
-	if (POS3.X.Scale >= 1) then
-		warnlog("POS3.X.Scale >= 1 >      . :", POS3.X.Scale)
-	end
-
-	ensureGui(player)
